...
#define SA0_PORT                                        HAL_GPIOA
#define SA0_PIN                                         HAL_GPIO_PIN_1
#define SA0_INIT_STATE                                  HAL_GPIO_PIN_RESET
#define SA0_ACTIVE_STATE                                HAL_GPIO_PIN_SET
#define SA0_INACTIVE_STATE                              HAL_GPIO_PIN_RESET

/* Primary aliases for GPIO PA6 pin */
#define CS2_PORT                                        HAL_GPIOA
#define CS2_PIN                                         HAL_GPIO_PIN_6
#define CS2_INIT_STATE                                  HAL_GPIO_PIN_RESET
#define CS2_ACTIVE_STATE                                HAL_GPIO_PIN_SET
#define CS2_INACTIVE_STATE                              HAL_GPIO_PIN_RESET

/* Primary aliases for GPIO PB2 pin */
#define CS1_PORT                                        HAL_GPIOB
#define CS1_PIN                                         HAL_GPIO_PIN_2
#define CS1_INIT_STATE                                  HAL_GPIO_PIN_RESET
#define CS1_ACTIVE_STATE                                HAL_GPIO_PIN_SET
#define CS1_INACTIVE_STATE                              HAL_GPIO_PIN_RESET
